...
import { Container, SectionTitle, Card, CardContent, AnimatedSection } from '../components';
      ...
      <section ref={heroRef} className="py-20 lg:py-32 relative overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="about-hero-text text-gray-400 text-lg mb-8 opacity-0">
              We help companies eliminate friction, increase productivity, and build digital systems that scale effortlessly.
            </p>
            <div className="about-hero-belief p-6 bg-gradient-to-r from-indigo-500/10 to-pink-500/10 rounded-2xl border border-white/10 inline-block opacity-0">
